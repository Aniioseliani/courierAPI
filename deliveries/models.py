...
class Parcel(models.Model):
    ...
    receiver_name = models.CharField(max_length=255)  # Assuming you want to store the receiver's name
    receiver_address = models.ForeignKey(CustomUser, related_name='courier_parcels', on_delete=models.CASCADE)
